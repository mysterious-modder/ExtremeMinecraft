...
public class RubyItem extends ExtrememinecraftModElements.ModElement {
	@ObjectHolder("extrememinecraft:ruby")
	public static final Item block = null;

	public RubyItem(ExtrememinecraftModElements instance) {
		super(instance, 1);
	}
