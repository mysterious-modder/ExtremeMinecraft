...
public class Ruby_setAxeItem extends ExtrememinecraftModElements.ModElement {
	@ObjectHolder("extrememinecraft:ruby_set_axe")
	public static final Item block = null;

	public Ruby_setAxeItem(ExtrememinecraftModElements instance) {
		super(instance, 8);
	}
