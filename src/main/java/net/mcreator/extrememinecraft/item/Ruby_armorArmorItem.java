...
public class Ruby_armorArmorItem extends ExtrememinecraftModElements.ModElement {
	@ObjectHolder("extrememinecraft:ruby_armor_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("extrememinecraft:ruby_armor_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("extrememinecraft:ruby_armor_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("extrememinecraft:ruby_armor_armor_boots")
	public static final Item boots = null;

	public Ruby_armorArmorItem(ExtrememinecraftModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "extrememinecraft:textures/models/armor/ruby_armor_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
