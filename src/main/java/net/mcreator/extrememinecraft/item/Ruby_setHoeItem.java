...
public class Ruby_setHoeItem extends ExtrememinecraftModElements.ModElement {
	@ObjectHolder("extrememinecraft:ruby_set_hoe")
	public static final Item block = null;

	public Ruby_setHoeItem(ExtrememinecraftModElements instance) {
		super(instance, 11);
	}
