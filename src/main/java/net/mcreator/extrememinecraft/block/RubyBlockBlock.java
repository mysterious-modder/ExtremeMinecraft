...
public class RubyBlockBlock extends ExtrememinecraftModElements.ModElement {
	@ObjectHolder("extrememinecraft:ruby_block")
	public static final Block block = null;

	public RubyBlockBlock(ExtrememinecraftModElements instance) {
		super(instance, 3);
	}
