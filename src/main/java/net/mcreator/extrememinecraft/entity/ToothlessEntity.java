...
package net.mcreator.extrememinecraft.entity;
...
public class ToothlessEntity extends ExtrememinecraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(2f, 1.7999999999999998f)).build("toothless").setRegistryName("toothless");

	public ToothlessEntity(ExtrememinecraftModElements instance) {
		super(instance, 23);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ToothlessRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10079233, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("toothless_spawn_egg"));
	}
