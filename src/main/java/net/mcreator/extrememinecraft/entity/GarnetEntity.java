...
public class GarnetEntity extends ExtrememinecraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("garnet").setRegistryName("garnet");

	public GarnetEntity(ExtrememinecraftModElements instance) {
		super(instance, 22);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -2293030, -12582601, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("garnet_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 20, 2, 10));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new LookAtGoal(this, MonsterEntity.class, (float) 6));
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, MonsterEntity.class, false, true));
